...
export default function MainLayout() {
  ...
  return (
    <div className="h-screen flex overflow-hidden font-['Inter'] bg-[#F5F7FA]">
      ...
      {/* BEGIN: LeftSidebar */}
      <aside className="w-64 bg-[#F6F7FF] border-r border-gray-200 flex flex-col h-full z-20" data-purpose="main-navigation">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 bg-[#F5F7FA] flex items-center justify-center relative overflow-hidden" data-purpose="main-display">
